...
setTimeout(() => {
  new CircleType(document.getElementById("activeProblems-curved-text")).radius(
    94
  );

  new CircleType(document.getElementById("pastProblems-curved-text"))
    .radius(94)
    .dir(-1);

  new CircleType(document.getElementById("medications-curved-text"))
    .radius(94)
    .dir(-1);

  new CircleType(document.getElementById("allergies-curved-text"))
    .radius(75)
    .dir(-1);
}, 500);
